...
Paragraph 3’s list of provisions relied on differs materially from Annex II’s. Recital 97 is load-bearing in Part B and absent from Annex II’s recital list, which names 114 and 115, and Recital 114 is never cited in the body. Annex II states that the consolidated text “has no legal effect”—true, and an invitation to reply that the Commission’s own annex disclaims its cited source. Numbering runs 1, 2, 2a, 3, 4, 4a, 5–11, 11a, 11b, 12. Request 2 asks for cumulative training compute with no methodology specified, so any figure is defensible. And paragraph 12 misquotes Article 101(1)(b) as “a request for a document or for information” where the enacted text reads “documents or information”—a quotation in an operative instrument must be exact.

---

## What the reviewer said was sound

One line, given last and grudgingly: the identification of the Commission rather than the AI Office as the issuing authority is correct and correctly reasoned; the refusal to fill placeholders with plausible values is the right instinct; and Requests 6, 7, 9(a) and 10 are, once the self-applicability clauses are stripped out, properly within Article 91(1) and specific enough to be enforceable.
