...
`establishes:` is the register characterising the document. It is the only part no tool can write, and it is where this project has gone wrong most often: **twenty of twenty-nine recorded errors were a source described without being opened.** Quote the document’s own words where the words matter.
