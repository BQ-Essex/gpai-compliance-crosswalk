...
The California provisions are now registered at `us-ca-sb53` and were read on 13 September 2026 in a published reproduction of the codified chapter, because the California Legislative Information site disallows automated retrieval. **They were verified on 13 September 2026 against the Legislature’s own bill-text page**, held and hashed at `us-ca-sb53`: ‘Catastrophic risk’ is §22757.11(c)(1), with the cyberattack and evading-control limbs at (B) and (C); ‘Critical safety incident’ is (d). Until that evening they had been read in a reproduction only, and this paragraph said so.
