...
| **Verdict** | **On the provider’s own account, this appears met**: the obligations attach. On the Commission’s reading a model integrated into its provider’s own AI system put into service is deemed placed on the market (Recital 97; Guidelines ¶54), internal processes essential to third-party provision are themselves an example of placement (Guidelines ¶51), development forms part of the same model’s lifecycle (Guidelines ¶22), and the internal-use exception is unavailable to a model with systemic risk (Q&A). |
...
| **(b)** serious **and irreversible** disruption of critical infrastructure | ‘Critical infrastructure’ = an asset or system “necessary for the provision of an essential service” (CER Art. 2(4)); essential services are identified by Member States within the Annex sectors (CER Art. 5), and Article 3(49)(b) requires disruption of “the management or operation of” it. Arguable on the functional test; **defeated on “irreversible”**—one core cluster wiped and rebuilt, credentials rotated. | Not engaged. |
