...
**The power is in use, and this is its incident-specific counterpart.** On 1 September 2026 the Commission stated that the AI Office had sent its first requests for information to more than 30 providers; they come “after several incidents involving AI models that occurred this summer”, the first strand concerning “safety and security” (Agence Europe, 3 September 2026). On the only public account of what those requests ask—model-theft prevention, evaluator access, post-deployment monitoring—none reaches the placement question above, which a request written across thirty providers could not ask.
