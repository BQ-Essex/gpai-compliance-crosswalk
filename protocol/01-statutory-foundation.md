...
**The searching has been done, and the answer is layered.** The Commission and the AI Board did publish an assessment of this Code: *Commission Opinion on the assessment of the General-Purpose AI Code of Practice*, 1 August 2025, confirming the Code as “an adequate voluntary tool for providers of GPAI models to demonstrate compliance with the AI Act”, with the Board’s Adequacy Assessment alongside it. But that opinion **predates the duty it would otherwise satisfy** by almost a year, and it is expressed in general terms rather than by reference to particular provisions.

What a provision-specific assessment looks like is visible on a neighbouring code. On 8 July 2026 the Commission concluded that the Code of Practice on Transparency of AI-generated Content “**adequately covers the obligations provided for in Articles 50(2), (4) and (5)** AI Act”, the Board adopting its Adequacy Assessment the following day. That is the Article 56(6) shape—named provisions, published, Board assessment alongside—applied days before the Omnibus entered into force.

**Negative-search note.** As of 12 September 2026, searching `digital-strategy.ec.europa.eu` including its library and search endpoints, and by general web search: no assessment of the GPAI Code published after 27 July 2026, and none expressed in the Article 56(6) formula of covering the obligations in Articles 53 and 55, was located. What the 1 August 2025 Commission Opinion document itself says is not known—only its landing page has been read.
